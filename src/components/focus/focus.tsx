...
import { getTasksInFocus, getAllGoalsFromLocal, updateTaskCompletion, toggleTaskFocus } from '@/lib/localforage'
import type { Task } from '@/lib/schema'
import type { GoalWithTasks, TaskFormValues } from '@/lib/types/types'
...
const Focus: React.FC = () => {
    ...
    const { addGoal } = useGoalManagement()
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const [tasks, allGoals] = await Promise.all([
                    getTasksInFocus(),
